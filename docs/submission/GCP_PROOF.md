...
*(Note: Replace these placeholders with actual screenshots and screen recordings before final submission.)*

### Screen Recording
*   **Walkthrough of Deployment:** [Link to screen recording / YouTube video placeholder] - *Shows the behind-the-scenes of the app running on GCP, including the Cloud Run revisions and Artifact Registry.*
