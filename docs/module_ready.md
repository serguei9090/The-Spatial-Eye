...
1.  **Module Boundaries**: Enforce stricter boundaries. For example, `atoms` should strictly _never_ import `molecules`. Use `dependency-cruiser` or `eslint-plugin-import` to enforce this programmatically.
